...
import mentor1 from './assets/ImagenesContacts-Mentoring/mentor1.jpg';
import mentor2 from './assets/ImagenesContacts-Mentoring/mentor2.jpg';
import mentor3 from './assets/ImagenesContacts-Mentoring/mentor3.jpg';
import mentor4 from './assets/ImagenesContacts-Mentoring/mentor4.jpg';
import mentor5 from './assets/ImagenesContacts-Mentoring/mentor5.jpg';
import mentor6 from './assets/ImagenesContacts-Mentoring/mentor6.jpg';
import mentoriaPareja from './assets/ImagenesContacts-Mentoring/mentoria-pareja.jpg';
  ...
  return (
    <div className="bg-white text-center font-montserrat">
      ...
      <div className="relative">
        <img
          src="/fondo-mentoring.jpg"
          alt="Mentoría"
          className="w-full h-72 object-cover"
        />
        <h2 className="absolute inset-0 flex items-center justify-center text-stroke text-3xl font-bold">
      ...
      <div className="my-12 px-6">
        ...
        <div className="relative">
          ...
          <div
            ref={carouselRef}
            className="flex space-x-6 overflow-x-auto px-2 scroll-smooth no-scrollbar"
          >
