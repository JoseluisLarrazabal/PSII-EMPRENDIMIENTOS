...
import logo from "../assets/images/Logo 1.png";      // Ajusta la ruta de tu logo
import imp1 from "../assets/images/semi1.jpg";         // Evento importante 1
import imp2 from "../assets/images/semi2.jpg";         // Evento importante 2
import imp3 from "../assets/images/semi3.jpg";         // Evento importante 3
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto flex items-center justify-between py-2 px-4">
          ...
          <ul className="flex space-x-6 text-sm font-semibold">
            <li>
              <a
                href="#"
                className="text-[#880043] pb-1 border-b-2 border-[#880043] hover:underline"
              >
                Acerca de nosotros
              </a>
            </li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {upcoming.map((e) => {
              ...
              return (
                <div
                  key={e.id}
                  className="bg-[#66b5cb] text-white p-4 rounded-lg shadow"
                >
      ...
      <footer className="bg-[#880043] py-4 mt-12">
        <div className="container mx-auto text-center text-white">
          &copy; {new Date().getFullYear()} Challenger Events. Todos los derechos reservados.
        </div>
      </footer>
    </div>
  );
