...
const CourseCard = ({ course }) => {
  ...
  return (
    <article className="flex flex-col h-full rounded-md overflow-hidden shadow-md border border-gray-100 hover:shadow-lg transition-shadow card-hover" tabIndex="0">
